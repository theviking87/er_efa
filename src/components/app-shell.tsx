...
const NAV = [
  ...
  { to: "/financeiro/processamentos", label: "Processamentos Formandos", icon: ClipboardList, section: "Financeiro" },
  { to: "/financeiro/formadores", label: "Processamentos Formadores", icon: Receipt, section: "Financeiro" },
