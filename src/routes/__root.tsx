...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Gestão de cursos, formadores, formandos e processamento financeiro." },
      { property: "og:title", content: "Gestão de Formação" },
      { property: "og:description", content: "Gestão de cursos, formadores, formandos e processamento financeiro." },
